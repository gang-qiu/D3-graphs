(function(){
	var width = 800, height = 400, padding = 50;
    ...
    var w = 1000, h = 1000;
    var cx = w/2 + 25, cy = h/2 + 25;
    var r_svg = d3.select('#dendrogram-radial-graph')
        .append('svg')
    ...
    var r_graph = d3.layout.cluster()
        .size([w, h])
        .sort(function(a,b) {return d3.ascending(a.name,b.name);})

    var r_nodes = r_graph.nodes(data);
    ...
    var r_links = r_graph.links(r_nodes);

    r_svg.selectAll('path')
        .data(r_links)
        .enter().append('path')
            .attr('d', d3.svg.diagonal())
            .attr('class', 'line')
